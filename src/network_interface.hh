...
private:
  ...
  size_t timer_ = 0;
  static const size_t ARP_REQUEST_INTERVAL_MS = 5000;
  static const size_t ARP_TIMEOUT_MS = 30000;

  std::unordered_map<uint32_t, std::queue<std::pair<InternetDatagram, size_t>>> datagrams_to_send_ {};
